            ...
            <div className="flex flex-col items-start justify-center space-y-6 sm:space-y-8 max-w-2xl text-center sm:text-left mx-auto sm:mx-0">
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-base sm:text-lg lg:text-[10px] xl:text-base 2xl:text-2xl 3xl:text-3xl font-medium">Free of Charge</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Check className="w-4 h-4 sm:w-5 sm:h-5 lg:w-3 lg:h-3 xl:w-4 xl:h-4 2xl:w-7 2xl:h-7" />
                  <span className="text-base sm:text-lg lg:text-[10px] xl:text-base 2xl:text-2xl 3xl:text-3xl font-medium">Paid Advertisement</span>
                </div>
              </motion.div>
