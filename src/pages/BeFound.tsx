              ...
              >
                <div className="space-y-10">
                  <div className="space-y-3">
                    <div className="text-5xl font-bold text-green-600">7M+</div>
                    <div className="text-2xl font-semibold text-gray-900">Users per year</div>
                  ...
                  <div className="space-y-3">
                    <div className="text-5xl font-bold text-green-600">12M+</div>
                    <div className="text-2xl font-semibold text-gray-900">Suppliers are viewed per month</div>
                    <ul className="space-y-2 text-gray-600">
                      <li className="flex items-center gap-2">
                        <Check className="w-5 h-5 text-green-600" />
                ...
                >
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 border border-white/10 h-full">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-14 h-14 min-w-14 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 text-white font-bold text-xl aspect-square">
                        {step.number}
                      </div>
