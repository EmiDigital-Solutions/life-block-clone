...
const TechnologyFeaturesSection = () => {
  ...
  const features = [
    { title: "AI Matching", desc: "50+ parameters. Perfect client alignment." },
    { title: "Mobile Platform", desc: "Audit from anywhere. iOS & Android." },
    { title: "Smart Reports", desc: "AI-assisted. 60% less admin time." },
    { title: "Fast Payments", desc: "14-day processing. No chasing invoices." },
  ];
