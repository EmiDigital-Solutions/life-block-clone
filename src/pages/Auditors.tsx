  ...
  return (
    <div className="min-h-screen">
      ...
      <div ref={containerRef}>
        ...
        {/* Become YVOO Auditor CTA Section */}
        <section className="py-24 md:py-32 bg-primary relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 lg:px-16 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Join 2,000+ certified professionals in 94 countries. Gain access to premium audit assignments, AI-powered tools, and a global network of quality experts.
              </motion.p>
              ...
              >
                <a
                  href="#"
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full font-medium transition-all duration-300 text-base bg-white text-primary hover:bg-white/90 shadow-lg hover:shadow-xl"
                >
                  Apply Now
                  <ArrowRight className="w-5 h-5" />
                </a>
                <a
                  href="#"
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full font-medium transition-all duration-300 text-base border-2 border-white/30 text-white hover:bg-white/10"
                >
                  Learn More
                </a>
              </motion.div>
              ...
              >
                <div className="flex flex-wrap items-center justify-center gap-8 text-white/70 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span>15% Acceptance Rate</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-white" />
                    <span>Premium Assignments</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-white" />
