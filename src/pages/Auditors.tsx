...
const DayInLifeSection = () => {
  ...
  const timeline = [
    {
      day: "Day 1",
      title: "You accept an audit outside your usual scope",
      oldWay: "A cryogenic valve manufacturer in Pune? You'd decline—unfamiliar process, no checklist, too much risk of looking unprepared.",
      newWay: "Atlas AI briefs you on the industry context, generates a tailored checklist, and highlights the critical process steps. You accept with confidence—the AI fills the knowledge gap.",
      highlight: "AI expands your range",
    },
    {
      day: "Day 2",
      title: "You prepare like a specialist",
      ...
      newWay: "Atlas AI pre-loads the client's specific requirements, supplier certifications, and previous audit history. It flags risk areas and suggests focus points—you walk in like you've audited them before.",
      highlight: "AI-powered preparation in hours",
    },
    {
      day: "Day 3",
      title: "You're on the shop floor with a co-pilot",
      ...
      newWay: "Atlas AI guides you question by question. Snap a photo—it's auto-linked to the finding. Unsure about a scoring? AI suggests a maturity level with reasoning. Flag a critical deviation—the client sees it in real time.",
      highlight: "AI ensures nothing gets missed",
    },
    {
      day: "Day 4",
      title: "Your report writes itself",
      ...
      newWay: "The report is 80% done before you leave the factory. Evidence photos organized, scores calculated, corrective actions drafted. You add your expert conclusions and submit—professional-grade output, every time.",
      highlight: "Consistent quality, zero formatting",
    },
    {
      day: "Day 5",
      title: "You get paid, they get insights",
      oldWay: "Write an invoice. Send it. Wait 60 days. Send a reminder. Wait 30 more days. Finally: payment received.",
      newWay: "Report approved → payment released same business day. Meanwhile, the client already has your findings in their dashboard with risk scores, trend data, and action tracking. Your work has immediate impact.",
      highlight: "Same-day payment. Lasting value.",
    },
  ];
