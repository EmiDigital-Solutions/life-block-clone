...
const DayInLifeSection = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      newWay: "Client-specific checklist pre-loaded. Supplier documents already uploaded. You review the process flow and plan your focus areas.",
      highlight: "Preparation time: hours, not days",
    },
    {
      day: "Day 3",
      ...
      newWay: "Digital checklist guides you step by step. Photos auto-linked to findings. Flag a critical deviation—client sees it in real time.",
      highlight: "You audit. The platform documents.",
    },
    {
      day: "Day 4",
      ...
      newWay: "Report auto-generated from your inputs. You refine the conclusions, add your expert judgment, and submit. Done before lunch.",
    ...
    },
    {
      ...
      newWay: "Report approved → payment released same business day. No invoice. No chasing. No uncertainty.",
