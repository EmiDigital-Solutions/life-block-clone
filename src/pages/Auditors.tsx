  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="section-headline text-gray-900 mb-6">
            <span className="text-primary">Professional Partnership</span> Platform
          </h2>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h2 className="section-headline text-gray-900 mb-4">
            <span className="text-primary">Partnership Journey</span>
          </h2>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="section-headline text-gray-900 mb-4">
            <span className="text-primary">Professional Standards</span>
          </h2>
          <p className="text-lg md:text-xl lg:text-xl text-gray-600">
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="section-headline text-gray-900 mb-4">
            <span className="text-primary">Partner Success Stories</span>
          </h2>
          <p className="text-lg md:text-xl lg:text-xl text-gray-600">
