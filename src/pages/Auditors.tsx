...
const DayInLifeSection = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      newWay: "Client-specific checklist pre-loaded with weighted scoring criteria. Previous audit findings, supplier certifications, and process documentation already in one place. Risk areas flagged—you know exactly where to focus before you arrive.",
    ...
    },
    {
      ...
      newWay: "Guided step-by-step through each audit question. Scan equipment—specifications auto-recognized. Photos auto-linked to findings as evidence. Unsure about a maturity score? AI suggests a level with reasoning you can accept or override. Flag a critical deviation—the client sees it instantly.",
