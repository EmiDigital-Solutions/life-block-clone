...
// WHAT WE OFFER SECTION - Premium B2B Style (replaces toggle section)
  ...
  const offerings = [
    {
      ...
      description: "Fortune 500 manufacturers, automotive OEMs, aerospace suppliers—clients who value thoroughness over speed."
    },
    {
      number: "02", 
      title: "Sustainable workload",
      description: "3-5 quality assignments monthly. No racing against the clock. No compromising standards."
    },
    {
      number: "03",
      title: "Professional tools",
      description: "Enterprise platform for scheduling, documentation, and client communication. Fast, reliable payments."
    },
  ];
    ...
    >
      <div className="container mx-auto px-6 lg:px-16">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-foreground leading-[1.1] tracking-tight max-w-3xl">
            Everything you need.
            <br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          {offerings.map((item, index) => (
            ...
            >
              <span className="text-5xl font-extralight text-primary/40 mb-4 block">{item.number}</span>
