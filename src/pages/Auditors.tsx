  ...
  const timeline = [
    {
      ...
      newWay: "The platform briefs you on industry context, generates a tailored checklist, and highlights critical process steps. You accept with confidence—the knowledge gap is filled before you arrive.",
      highlight: "Your range expands",
    },
    {
      day: "Day 2",
      ...
      newWay: "Client-specific requirements pre-loaded. Supplier certifications and previous findings already flagged. Risk areas highlighted—you walk in like you've audited them before.",
    ...
    },
    {
      ...
      newWay: "Report approved → payment released same business day. The client already has your findings in their dashboard with risk scores, trend data, and action tracking. Your work has immediate impact.",
