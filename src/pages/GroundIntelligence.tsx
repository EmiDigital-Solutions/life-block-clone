        ...
        <div className="container mx-auto">
          <div className="flex flex-col items-start justify-center space-y-6 sm:space-y-8 max-w-2xl text-center sm:text-left mx-auto sm:mx-0">
            <motion.h1 
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-[24px] xl:text-3xl 2xl:text-7xl 3xl:text-8xl font-sans font-bold text-white leading-tight"
            >
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-base sm:text-lg lg:text-[13px] xl:text-base 2xl:text-2xl 3xl:text-3xl font-medium">Real-time monitoring</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 lg:w-3 lg:h-3 xl:w-4 xl:h-4 2xl:w-7 2xl:h-7" />
                <span className="text-base sm:text-lg lg:text-[13px] xl:text-base 2xl:text-2xl 3xl:text-3xl font-medium">Predictive analytics</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 lg:w-3 lg:h-3 xl:w-4 xl:h-4 2xl:w-7 2xl:h-7" />
                <span className="text-base sm:text-lg lg:text-[13px] xl:text-base 2xl:text-2xl 3xl:text-3xl font-medium">Risk scoring</span>
              </div>
            </motion.div>
            ...
            >
              <button 
                ...
                className="w-full sm:w-auto group inline-flex items-center justify-center gap-2 bg-white text-gray-900 px-6 sm:px-8 lg:px-5 xl:px-7 2xl:px-12 py-3 sm:py-4 lg:py-2.5 xl:py-3 2xl:py-6 rounded-full font-sans font-semibold hover:bg-opacity-90 transition-all duration-300 text-base sm:text-lg lg:text-[13px] xl:text-base 2xl:text-2xl 3xl:text-3xl min-h-[48px]"
              >
            ...
            <motion.p
              ...
              className="text-sm sm:text-base lg:text-[13px] xl:text-base 2xl:text-xl 3xl:text-2xl text-white/90 font-sans max-w-xl leading-relaxed mx-auto sm:mx-0"
            >
