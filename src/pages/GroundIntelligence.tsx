          ...
          <div className="flex flex-col items-start justify-center space-y-6 sm:space-y-8 max-w-2xl text-center sm:text-left mx-auto sm:mx-0">
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3">
                <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 xl:w-5 xl:h-5 2xl:w-7 2xl:h-7" />
                <span className="text-base sm:text-lg xl:text-lg 2xl:text-2xl 3xl:text-3xl font-medium">Real-time monitoring</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 xl:w-5 xl:h-5 2xl:w-7 2xl:h-7" />
                <span className="text-base sm:text-lg xl:text-lg 2xl:text-2xl 3xl:text-3xl font-medium">Predictive analytics</span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3">
                <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 xl:w-5 xl:h-5 2xl:w-7 2xl:h-7" />
                <span className="text-base sm:text-lg xl:text-lg 2xl:text-2xl 3xl:text-3xl font-medium">Risk scoring</span>
              </div>
            </motion.div>
