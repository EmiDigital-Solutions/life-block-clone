                  ...
                  >
                    <Card className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 h-full border-0 overflow-hidden hover:scale-[1.02] group">
                      <div className="flex items-start gap-0">
                        ...
                        <div className="w-21 h-21 bg-gradient-to-br from-red-50 to-red-100/30 flex items-center justify-center relative flex-shrink-0">
                          {/* Large red ! watermark */}
                          <span className="text-[42px] font-black text-red-500/40 leading-none select-none">
                            !
                          </span>
                        </div>
