...
const HeroSection = () => {
  ...
  return (
    <section data-nav-theme="dark" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      {/* Content - Single Column Left-Aligned Layout */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-start text-left space-y-8 max-w-3xl">
            ...
            <motion.h1 
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-sans font-semibold text-primary leading-tight tracking-tight"
            >
            ...
            <motion.h2 
              ...
              className="text-xl md:text-2xl font-sans font-medium text-primary/80 tracking-wide"
            >
