  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute -bottom-60 -left-40 w-[800px] h-[800px] rounded-full opacity-20"
          style={{
        ...
        {/* Corner accents */}
        <div className="absolute top-20 left-10 w-20 h-20 border-l-2 border-t-2 border-primary/10 rounded-tl-lg" />
        <div className="absolute bottom-40 right-10 w-20 h-20 border-r-2 border-b-2 border-primary/10 rounded-br-lg" />
      </div>
