      ...
      <div className="flex-1 flex items-center relative z-10 pt-28 pb-8">
        <div className="container mx-auto px-4 lg:px-6 relative">
          ...
          <motion.div 
            ...
            className="relative z-20 overflow-visible lg:-ml-8 xl:-ml-12 2xl:-ml-16 max-w-md lg:max-w-lg"
          >
            {/* Tagline Badge */}
            <motion.div
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.3 }}
            className="hidden lg:block absolute top-1/2 -translate-y-1/2 right-0 z-10 w-[55%] xl:w-[58%] 2xl:w-[60%]"
            style={{ right: '-5%' }}
          >
            <div 
