...
const fallbackAuditors = [
  ...
  { image: auditorFemaleAfrican, location: "Africa", region: "Sub-Saharan" },
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white to-transparent pt-16 sm:pt-20 lg:pt-10 xl:pt-24 2xl:pt-28 3xl:pt-32 pb-4 sm:pb-5 lg:pb-3 xl:pb-6 2xl:pb-8 3xl:pb-10 px-4 sm:px-6 lg:px-3 xl:px-6 2xl:px-7 3xl:px-8">
