...
const TimeEfficiencyChart = () => {
  ...
  const phases = [
    { name: 'Auditor Search', traditional: 14, scanpro: 1, visualScanpro: 0.8, color: 'hsl(192, 20%, 72%)' },
    { name: 'Preparation', traditional: 7, scanpro: 2, visualScanpro: 0.8, color: 'hsl(195, 89%, 34%)' },
    { name: 'On-site Audit', traditional: 3, scanpro: 2, visualScanpro: 0.8, color: '#6B7280' },
    { name: 'Report', traditional: 10, scanpro: 0.5, visualScanpro: 0.5, color: 'hsl(192, 20%, 72%)' },
  ];
    ...
    <div ref={ref} className="w-full">
      <div className="space-y-6 sm:space-y-10 mb-6 sm:mb-10">
        ...
        <div>
          <div className="flex items-center justify-between mb-3 sm:mb-5">
            <h4 className="text-xs sm:text-sm md:text-base font-bold text-gray-900 flex items-center gap-2 sm:gap-3">
              <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-primary" strokeWidth={2.5} />
          ...
          <div className="relative flex items-center gap-2 sm:gap-4">
            ...
            >
              <span className="text-lg sm:text-xl md:text-2xl font-black text-primary">{totalScanPro} days</span>
            </motion.div>
          </div>
        </div>
      </div>
