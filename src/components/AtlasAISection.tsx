      ...
      <div className="mx-auto max-w-[1400px] px-8">
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-0">
          ...
          >
            ...
            <Link
              to="/features"
              className="inline-flex items-center justify-center gap-2 bg-primary text-white py-4 font-mono text-base font-medium hover:bg-primary/90 transition-colors tracking-wide lowercase w-[calc(100%/6)]"
            >
              explore atlas ai
