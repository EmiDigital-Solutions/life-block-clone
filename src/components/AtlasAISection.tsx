      ...
      <div className="mx-auto max-w-[1400px] px-8">
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-0">
          ...
          >
            ...
            <Link
              to="/features"
              className="inline-flex items-center gap-2 bg-foreground text-background px-6 py-3 font-mono text-sm font-medium hover:bg-foreground/90 transition-colors"
            >
              explore atlas ai
            </Link>
          </motion.div>
