  ...
  return (
    <nav className="fixed top-3 left-1/2 -translate-x-1/2 z-50 w-[94%] md:w-[500px]" ref={menuRef}>
      <div 
        ...
        style={{
          background: 'linear-gradient(to right, rgba(255,255,255,0.8) 0%, rgba(255,255,255,0.5) 8%, rgba(255,255,255,0.3) 50%, rgba(255,255,255,0.5) 92%, rgba(255,255,255,0.8) 100%), linear-gradient(to bottom, rgba(255,255,255,0.8) 0%, rgba(255,255,255,0.45) 20%, rgba(255,255,255,0.3) 50%, rgba(255,255,255,0.45) 80%, rgba(255,255,255,0.8) 100%)',
