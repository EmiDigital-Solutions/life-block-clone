...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-2 left-1/2 -translate-x-1/2 z-50 w-[75%] md:w-auto" ref={menuRef}>
      <div 
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 flex items-center justify-end">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 md:gap-3 bg-foreground text-white pl-5 pr-4 py-3 md:pl-8 md:pr-7 md:py-6 my-1 mr-1 md:my-1.5 md:mr-1.5 rounded-full font-bold text-2xl md:text-2xl tracking-tight hover:bg-foreground/90 transition-all duration-300"
            >
              Demo
