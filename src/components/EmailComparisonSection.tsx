...
const EmailComparisonSection = () => {
  ...
  const withYVOOContent = [
    ...
    { time: "Day 2", title: "Auditor ready", description: "Certified IATF/ISO auditor matched and mobilized within 3 days. No waiting for your quality team's availability. No capacity constraints. No supplier rescheduling. Professional auditor ready to deploy." },
