      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 gap-x-12 mb-24">
          ...
          <motion.div
            ...
            className="pb-12"
          >
            <p className="text-sm text-foreground/50 font-mono tracking-wide mb-2">Audit lead time</p>
            <div className="border-t border-foreground/20 pt-4">
              <p className="text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-4 tracking-[-0.02em]">
                72%
              </p>
              <p className="text-foreground/60 leading-relaxed text-sm">
                Faster audit cycles compared to traditional methods
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="pb-12"
          >
            <p className="text-sm text-foreground/50 font-mono tracking-wide mb-2">Cost savings</p>
            <div className="border-t border-foreground/20 pt-4">
              <p className="text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-4 tracking-[-0.02em]">
                60%
              </p>
              <p className="text-foreground/60 leading-relaxed text-sm">
                Lower audit costs with local certified auditors
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="pb-12"
          >
            <p className="text-sm text-foreground/50 font-mono tracking-wide mb-2">Global network</p>
            <div className="border-t border-foreground/20 pt-4">
              <p className="text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-4 tracking-[-0.02em]">
                12K+
              </p>
              <p className="text-foreground/60 leading-relaxed text-sm">
                Certified auditors in 50+ countries
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="pb-12"
          >
            <p className="text-sm text-foreground/50 font-mono tracking-wide mb-2">Report delivery</p>
            <div className="border-t border-foreground/20 pt-4">
              <p className="text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-4 tracking-[-0.02em]">
                24h
              </p>
              <p className="text-foreground/60 leading-relaxed text-sm">
                Digital audit reports delivered within hours
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          ...
          <UseCaseCard
            ...
            badge={useCases[1].badge}
            title={useCases[1].title}
            description={useCases[1].description}
            delay={0.1}
          />
          ...
          <UseCaseCard
            ...
            badge={useCases[2].badge}
            title={useCases[2].title}
            description={useCases[2].description}
            delay={0.2}
          />
        </div>

        {/* Full width bottom card - Electronics */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.3 }}
          className="group relative w-full overflow-hidden cursor-pointer mt-4 md:mt-6"
        >
          {/* Full-bleed image container */}
