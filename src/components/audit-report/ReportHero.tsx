  ...
  return (
    <section id="station-1" className="min-h-[100dvh] flex flex-col justify-center relative scroll-mt-20 py-12">
      <div className="relative z-10 max-w-[880px] mx-auto w-full">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2">
            {['ISO 9001', 'IATF 16949', 'VDA 6.3'].map(badge => (
              <span key={badge} className="text-[9px] font-bold tracking-[0.1em] uppercase px-2 py-1" style={{ background: 'hsl(0,0%,88%)', color: 'hsl(0,0%,45%)' }}>
                {badge}
              </span>
            ))}
          </div>
        ...
        <div className="p-8 md:p-10 mb-6" style={{
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            <div className="flex-1 min-w-0">
              ...
              {/* Executive Summary */}
              <div className="mt-5 p-4" style={{ background: 'hsl(0,0%,92%)' }}>
            ...
            <div className="w-full md:w-[300px] shrink-0">
              <div className="p-5" style={{ background: 'hsla(0,0%,100%,0.5)' }}>
        ...
        <div className="p-4 mb-6" style={{ background: 'hsla(0,0%,100%,0.7)', backdropFilter: 'blur(12px)' }}>
