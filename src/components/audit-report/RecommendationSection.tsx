  ...
  return (
    <section id="station-13" className="scroll-mt-20 space-y-8">
      <div className="flex items-center gap-3 mb-2">
        <span className="text-[14px] font-medium tracking-[0.1em] text-muted-foreground">// 13</span>
        <span className="w-1.5 h-1.5 rounded-full bg-primary" />
        <span className="text-[14px] font-medium tracking-[0.1em] text-muted-foreground">Recommendation</span>
      ...
      <div className="bg-card shadow-sm p-6 md:p-8">
        <h4 className="text-[13px] uppercase tracking-[0.12em] text-muted-foreground font-semibold mb-6">Monday Morning — 3 actions</h4>
        <div className="space-y-3">
          {nextSteps.map((step, i) => (
            <div key={i} className="flex items-center gap-4 p-4 hover:bg-muted/60 transition-colors group">
              ...
              <button className="px-3 py-1.5 text-[14px] font-medium text-primary border border-primary/20 hover:bg-primary/5 opacity-0 group-hover:opacity-100 transition-all">
                {step.action}
              </button>
            </div>
          ))}
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-card shadow-sm p-5 space-y-3">
          <h4 className="text-[13px] uppercase tracking-[0.12em] text-muted-foreground font-semibold">Export</h4>
          <div className="space-y-2">
            <button className="w-full flex items-center gap-3 px-4 py-3 hover:bg-muted/60 transition-colors text-left">
              <FileDown className="w-4 h-4 text-primary" />
              <div>
                <span className="text-[15px] text-foreground font-medium">PDF with Corporate Branding</span>
                <p className="text-[12px] text-muted-foreground">Client logo, custom header/footer, cover page</p>
              </div>
            </button>
            <button className="w-full flex items-center gap-3 px-4 py-3 hover:bg-muted/60 transition-colors text-left">
              <Printer className="w-4 h-4 text-primary" />
              <div>
                <span className="text-[15px] text-foreground font-medium">Print-Ready Format</span>
                <p className="text-[12px] text-muted-foreground">Optimized for A4, grayscale safe</p>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="bg-card shadow-sm p-5 space-y-3">
          <h4 className="text-[13px] uppercase tracking-[0.12em] text-muted-foreground font-semibold">Role-Based Views</h4>
          <div className="space-y-2">
            {[
              ...
              <button key={i} className="w-full flex items-center gap-3 px-4 py-3 hover:bg-muted/60 transition-colors text-left">
                ...
                <div>
                  <span className="text-[15px] text-foreground font-medium">{view.role}</span>
                  <p className="text-[12px] text-muted-foreground">{view.desc}</p>
                </div>
              </button>
            ))}
          </div>
      ...
      <div className="border-none p-6 text-center">
        ...
        <button className="px-6 py-2.5 text-[15px] font-medium text-foreground hover:bg-muted/60 transition-colors">
          Switch to Supplier View →
        </button>
      </div>
    </section>
