...
export default function NCRCard({ ncr, compact, onAssign, onAction }: NCRCardProps) {
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-3 px-3 py-2.5" style={{ background: 'hsla(0,0%,100%,0.7)' }}>
  ...
  return (
    <div className="p-5 transition-all" style={{ background: 'hsla(0,0%,100%,0.7)', backdropFilter: 'blur(12px)' }}>
