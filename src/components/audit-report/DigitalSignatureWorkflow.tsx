            ...
            <div key={i} className="flex items-start gap-4 p-4 border-b border-border/40 last:border-b-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-[11px] uppercase tracking-[0.1em] text-muted-foreground font-semibold">{step.role}</span>
                ...
                {step.timestamp && (
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    {step.hash && (
                      <span className="text-[10px] font-mono text-grey-mid flex items-center gap-1">
