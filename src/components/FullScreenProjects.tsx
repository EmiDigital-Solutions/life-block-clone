              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${!isEven ? 'lg:grid-flow-dense' : ''}`}>
                ...
                >
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="inline-flex items-center gap-2 rounded-full px-4 py-2 bg-gray-100"
                  >
                  ...
                  <motion.p 
                    ...
                    viewport={{ once: true }}
                    className="text-lg sm:text-xl leading-relaxed max-w-xl text-gray-600"
                  >
                    {project.description}
                  </motion.p>
                  ...
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full font-medium transition-all duration-300 bg-gray-900 text-white hover:bg-gray-800"
                  >
                    Learn more
