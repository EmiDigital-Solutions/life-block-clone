      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="w-full max-w-2xl">
            <Earth3D height="500px" showPins={true} />
          </div>
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <button className="bg-primary text-primary-foreground px-8 py-3 rounded-full font-semibold text-sm transition-all duration-300 hover:opacity-90 flex items-center gap-3 group">
