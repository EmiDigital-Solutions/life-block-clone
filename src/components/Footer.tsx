      ...
      <div className="container mx-auto px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-4">YVOO</h3>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/audit-suppliers" className="text-gray-400 hover:text-white transition-colors">
                    Audit Suppliers
                  </Link>
                </li>
                <li>
                  <Link to="/become-visible" className="text-gray-400 hover:text-white transition-colors">
                    Become Visible
                  </Link>
                </li>
              </ul>
