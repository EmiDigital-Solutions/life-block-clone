      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div 
            ...
            style={{
              background: "linear-gradient(135deg, rgb(37, 99, 235), rgb(29, 78, 216), rgb(30, 64, 175))",
              boxShadow: "0 30px 60px -15px rgba(37, 99, 235, 0.4), 0 0 40px rgba(255,255,255,0.1) inset",
            }}
          >
