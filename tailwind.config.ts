  	...
  	extend: {
		...
		keyframes: {
			...
			'navGlow': {
				...
				'50%': {
					boxShadow: '0 8px 40px rgba(0, 0, 0, 0.12), 0 4px 16px rgba(0, 0, 0, 0.06), inset 0 0 140px rgba(255,255,255,0.6), inset 0 2px 8px rgba(255,255,255,0.7)'
				}
			}
		},
		animation: {
			...
			'navGlow': 'navGlow 4s ease-in-out infinite'
		}
  	}
  },
